...
<body>
    <nav class="navbar">
        <div class="container ">
        <a href="<?= site_url("Proizvodjac") ?>">   <img id="slika" src="<?php echo base_url('./slike/logo.png');?>" width="80px" height="80px"></a>
            ...
            <h1> &nbsp; &nbsp; &nbsp;  AgroMerge</h1>
             ...
             <ul class="navbar-nav d-flex flex-row" >
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <li class="nav-item">
                        <a class="nav-link link-light" aria-current="page" href="<?=site_url("Proizvodjac/izmeniObrisi")?>">Izmeni ponude</a>
