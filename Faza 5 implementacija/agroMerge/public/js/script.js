function inicijalizujPromenljive(){
   ...
   if(document.getElementById("fizickoLiceCB").checked){
        prikaziPotrosaca();
        prikaziFizickoLice();
   }
   else if(document.getElementById("pravnoLiceCB").checked){
       prikaziPotrosaca();
       prikaziPravnoLice();
   }
   
    else if(document.getElementById("proizvodjacCB").checked){
        prikaziProizvodjaca();
    }
}
...
function prikaziProizvodjaca(){
    ...
    document.getElementById('potrosacCB').checked=false;
}
function prikaziPotrosaca(){
    let proizvodjac = document.getElementById("proizvodjac");
    proizvodjac.style.display="none";
    potrosac.style.display="block";
    document.getElementById('proizvodjacCB').checked=false;
}
function prikaziFizickoLice(){
    ...
    document.getElementById('pravnoLiceCB').checked=false;
}
function prikaziPravnoLice(){
    ...
    document.getElementById('fizickoLiceCB').checked=false;
}
